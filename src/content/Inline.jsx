...
function Inline() {
    ...
    const listener = (msg) => {
      ...
      browser.runtime.onMessage.addListener((message) => {
        if (message.type === "DATA") {
          ...
          // Now you can use the context and user data in your content script
          console.log("Received context:", context);
          console.log("Received user:", user);
      
          // You can perform actions using the received data here
        }
      });
      
      // console.log(msg,"InliMessageeeeeeeeeeee");
  ...
  console.log(context,"Inlinecontexttttttttttttttttt")
